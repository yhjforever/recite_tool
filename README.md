...
|---|---|---|
| Windows 10 / 11 | [`recite_tool_windows.zip`](https://github.com/yhjforever/recite_tool/releases/download/v1.0.0/recite_tool_windows.zip) | `背诵稿生成器\背诵稿生成器.exe` |
| macOS | [`recite_tool_macos.zip`](https://github.com/yhjforever/recite_tool/releases/download/v1.0.0/recite_tool_macos.zip) | `recite_tool_mac\启动.command` |
