...
- 当前最新版：`v1.1.0`
- **Windows 10 / 11：[下载 Windows 版 recite_tool_windows.zip](https://github.com/yhjforever/recite_tool/releases/download/v1.1.0/recite_tool_windows.zip)**
- **macOS：[下载 macOS 版 recite_tool_macos.zip](https://github.com/yhjforever/recite_tool/releases/download/v1.1.0/recite_tool_macos.zip)**
...
|---|---|---|
| Windows 10 / 11 | [`recite_tool_windows.zip`](https://github.com/yhjforever/recite_tool/releases/download/v1.1.0/recite_tool_windows.zip) | `背诵稿生成器\背诵稿生成器.exe` |
| macOS | [`recite_tool_macos.zip`](https://github.com/yhjforever/recite_tool/releases/download/v1.1.0/recite_tool_macos.zip) | `recite_tool_mac\启动.command` |
